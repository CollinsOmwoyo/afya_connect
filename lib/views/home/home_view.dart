                ...
                builder: (context, clinicProvider, child) {
                  ...
                  return SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final clinic = clinicProvider.clinics[index];
                        return _SuggestionCard(title: clinic.name, color: Colors.teal);
                      },
                    ),
                  );
                },
...
class _SuggestionCard extends StatelessWidget {
  ...
  const _SuggestionCard({required this.title, required this.color});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Text(title, style: TextStyle(color: color, fontSize: 14, fontWeight: FontWeight.w600), textAlign: TextAlign.center),
      ),
    );
  }
}
